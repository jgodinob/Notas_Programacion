...
<table>
  ...
  <tr>
    ...
    <td>
      Determine el formato a utilizar para la información de asignación.
    </td>
  </tr>  
    <tr>
    <td>
    ...
    <td>
      Formato de configuración (yml,xml,php, o anotación) [anotación]:<i>yml</i>
    </td>
  </tr> 
  <tr>
    <td>
     ...
     (named id).</br>
      Available types: array, simple_array, json_array, object,</br>
      boolean, integer, smallint, bigint, string, text, datetime,</br>
      datetimetz, date, time, decimal, float, binary, blob, guid.</br>
    </td>
    <td>
      En lugar de comenzar con una entidad en blanco, puede agregar </ br>
      algunos campos ahora. </ br>
      Tenga en cuenta que la clave principal se agregará automáticamente </ br>
     (identificador con nombre). </ br>
      Tipos disponibles: array, simple_array, json_array, object, </ br>
      boolean, entero, smallint, bigint, cadena, texto, datetime, </ br>
      datetimetz, fecha, hora, decimal, flotador, binario, mancha, guid. </ br>
    </td>
  </tr> 
  <tr>
     <td>
      New field name (press <return> to stop adding fields): username</br>
    ...
    <td>
      Nuevo nombre de campo (presione <volver> para dejar de agregar campos): </ br>
  ...
  <tr>
     <td>
      New field name (press <return> to stop adding fields): password</br>
      Field type [string]:</br>
     ...
     <td>
      Nuevo nombre de campo (presione <volver> para dejar de agregar campos): password </ br>
      Tipo de campo [cadena]: </ br>
