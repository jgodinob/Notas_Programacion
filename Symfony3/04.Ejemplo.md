...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>
     Instead of starting with a blank entity, you can add some fields now.</br>
      Note that the primary key will be added automatically (named id).</br>
      Available types: array, simple_array, json_array, object,</br>
      boolean, integer, smallint, bigint, string, text, datetime, datetimetz,</br>
      date, time, decimal, float, binary, blob, guid.</br>
