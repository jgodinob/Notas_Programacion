...
<table>
  ...
  <tr> 
    <td>
      The Entity shortcut name: <string><i>PixelpromiCMSBundle:User</i></string>
    </td>
    <td>
      El nombre de método abreviado de entidad: <br>
     <string><i>PixelpromiCMSBundle:User</i></string>
    </td>
  </tr>
 </table>
...
<table>
  <tr>
    ...
    <td>
     ...
     [annotation]:<string><i>yml</i></string>
    </td>
    <td>
      Formato de configuración (yml,xml,php, o anotación) <br>
     [anotación]:<string><i>yml</i></string>
    </td>
  </tr> 
  <tr>
    <td>
  ...
  <tr>
     <td>
      ...
      fields): <string><i>username</i></string><br>
      Field type [string]:<br>
      Field length [255]: <string><i>35</i></string><br>
      Is nullable [false]:<br>
      Unique [false]:<br>
    </td>
    <td>
      Nuevo nombre de campo (presione <volver> para dejar <br>
      de agregar campos): <string><i>username</i></string><br>
      Tipo de campo [cadena]: <br>
      Longitud del campo [255]: <string><i>35</i></string> <br>
  ...
  <tr>
     <td>
      New field name (press <return> to stop adding <br>
      fields): <string><i>password</i></string><br>
      Field type [string]:<br>
      Field length [255]: <string><i>80</i></string><br>
      Is nullable [false]:<br>
      Unique [false]:<br>
     </td>
     <td>
      Nuevo nombre de campo (presione <volver> para dejar<br>
      de agregar campos): <string><i>password</i></string><br>
      Tipo de campo [cadena]: <br>
      Longitud del campo [255]: <string><i>80</i></string> <br>
      Es anulable [false]: <br>
      Único [falso]: <br>
     </td>
  </tr> 
...
*Nota<sup>2</sup>* Habrá que implementar la clase `userInterface`, sustituyendo la línea `class User{}` por `class User implements UserInterface{}`.

*Nota<sup>3</sup>* Añadimos dentro de la clase los métodos especiales que necesitaremos.
```php
class User implements UserInterface
{
/* Código Anterior */
