...
```
**Nota** Para obtener más información sobre formularios accede a la documentación oficial en [http://symfony.com/doc/current/forms.html](http://symfony.com/doc/current/forms.html)
