...
2.1.Crear un Bundle
-------------------
Para crear un nuevo plugin o **Bundle** usaremos el siguiente código `php bin/console generate:bundle --namespace=Pixelpro/HolaMundoBundle` dónde el **bundle** será **PixelPro** y la aplicación **HolaMundoBundle**. A continuación desplegará un gestor que nos ayudará a configurar el **bundle**.
