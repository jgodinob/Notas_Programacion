...
Para iniciar el servidor de **symfony** es necesario escribir dentro de la consola (CMD o CygWin) el comando `php bin/console server:run` dentro de la carpeta del proyecto de symfony.
**Opción A**
