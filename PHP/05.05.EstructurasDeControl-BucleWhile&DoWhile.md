...
**Ejercicio 5.18.** Vamos a crear tres programas distintos que realicen la misma tarea, para practicar un poco: uno con for, otro con while y el tercero con do/while. El programa en cuestión debe ofrecernos la tabla de multiplicar del 2.
```php
<!DOCTYPE html>
<html>
 <head>
...
**Ejercicio 5.19.** Vamos a crear un programa que calcule los números primos entre 1 y 50 y los muestre por pantalla. Recuerda que un número primo es un número entero que sólo es divisible por 1 y por sí mismo.
```php
<!DOCTYPE html>
<html>
 <head>
...
**Ejercicio 5.20.** Diferenciar números pares e impares con While y Do While
```php
<html lang="es">
	<head>
		<title>Ejercicio</title>
...
**Ejercicio 5.21.** Escribe un programa que multiplique los 20 primeros números naturales. Utiliza el bucle While.
```php
<meta charset="utf-8" />
<?php
$number = 1;
...
**Ejercicio 5.22.** Escribe un programa que recoja un número pasado en un parámetro GET por la URL, y lo multiplique por todos los números naturales anteriores a él. Utiliza el bucle While.
```php
<meta charset="utf-8" />
<?php
