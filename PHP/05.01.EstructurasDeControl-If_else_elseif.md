...
5. [ESTRUCTURAS DE CONTROL](#5estructuras-de-control)
	1. [Instrucción condicional If](https://github.com/HecFranco/Apuntes/blob/master/PHP/05.02.EstructurasDeControl_Switch.md#51instruccion-condicional-if)
		* [Operadores de igualdad (==) y Asignación (=)](#511operadores-de-igualdad--y-asignación-)
		* [Else y elseif](#512else-y-elseif)
	2. [Else y Elseif](#52else-y-elseif)
	3. [Switch](https://github.com/HecFranco/Apuntes/blob/master/PHP/05.02.EstructurasDeControl_Switch.md)
