...
```sql
INSERT INTO `ofertas` (`sku`, `nombre`, `introDescripcion`, `descripcion`, `img`, `precio`, `precioOferta`, `moneda`) VALUES(001, 'SPA para 2', 'Vive un momento inolvidable en la Sierra Norte', 'No te puedes perder...', '/img/spa.jpg', 18.00, 18.00, 'Euros');
INSERT INTO `ofertas` (`sku`, `nombre`, `introDescripcion`, `descripcion`, `img`, `precio`, `precioOferta`, `moneda`) VALUES(002, 'Especial Sushi', 'El auténtico sabor de Japón en Barcelona', 'No te puedes perder...', 'img/sushi.jpg', 79.00, 19.00, 'Euros');
INSERT INTO `ofertas` (`sku`, `nombre`, `introDescripcion`, `descripcion`, `img`, `precio`, `precioOferta`, `moneda`) VALUES(003, 'Carnes a la brasa', 'Chuletón de ternera con patatas', 'No te puedes perder...', 'img/carne.jpg', 249.00, 59.00, 'Euros');
INSERT INTO `ofertas` (`sku`, `nombre`, `introDescripcion`, `descripcion`, `img`, `precio`, `precioOferta`, `moneda`) VALUES(004, 'Lavado de coche', 'Nosotros lo hacemos por usted', 'No te puedes perder...', 'img/car.jpg', 19.00, 9.00, 'Euros');
```
...
12.3.Conexión con la Base de Datos
----------------------------------
...
12.5.Consultas a la Base de Datos
---------------------------------
**PRIMEROS PASOS**
