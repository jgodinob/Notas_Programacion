...
**Ejercicio 9.13. - Lectura de archivos - funcion fputs** Partiremos del supuesto del ejercicio anterior. Tenemos un archivo llamado pedidos.txt en el que nos han dejado guardado el menú solicitado. Vamos a crear un programa que muestre el contenido del archivo de pedido.
```php
<!DOCTYPE html>
<html>
 	<head>
